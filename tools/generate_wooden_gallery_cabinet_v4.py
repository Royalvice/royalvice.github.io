...
OUT_GLB = ROOT / "public/assets/gallery/models/wooden-gallery-cabinet-v4.glb"
OUT_REPORT = ROOT / "public/assets/gallery/models/wooden-gallery-cabinet-v4.report.json"
...
MATERIALS = {
    ...
    "mat_cherry_interior": (0.72, 0.355, 0.160, 1.0),
    "mat_right_wall_dark": (0.44, 0.185, 0.082, 1.0),
    "mat_dark_floor": (0.20, 0.105, 0.058, 1.0),
    "mat_corner_shadow": (0.030, 0.010, 0.004, 0.26),
...
def build_cabinet() -> dict:
    ...
    for index, (slot_x, slot_z) in enumerate(SLOT_CENTERS):
        ...
        # V4 keeps only narrow physical corner darkening. V3 used wide matte AO
        ...
        add_ao_strip(f"{prefix}.ao-back-floor", (slot_x, BACK_Y - PANEL - 0.012, bottom_z + 0.036), (INNER_W - 0.18, 0.010, 0.050), materials["mat_corner_shadow"], root)
        add_ao_strip(f"{prefix}.ao-left-floor", (left_x + PANEL + 0.012, 0.03, bottom_z + 0.034), (0.018, DEPTH - 0.22, 0.050), materials["mat_corner_shadow"], root)
        add_ao_strip(f"{prefix}.ao-right-floor", (right_x - PANEL - 0.012, 0.03, bottom_z + 0.034), (0.018, DEPTH - 0.22, 0.050), materials["mat_corner_shadow"], root)
        add_ao_strip(f"{prefix}.ao-back-right-corner", (right_x - PANEL - 0.012, BACK_Y - PANEL - 0.014, slot_z), (0.018, 0.010, INNER_H - 0.34), materials["mat_corner_shadow"], root)
        add_ao_strip(f"{prefix}.ao-back-left-corner", (left_x + PANEL + 0.012, BACK_Y - PANEL - 0.014, slot_z), (0.018, 0.010, INNER_H - 0.34), materials["mat_corner_shadow"], root)
        add_ao_strip(f"{prefix}.ao-ceiling-back", (slot_x, BACK_Y - PANEL - 0.012, top_z - PANEL - 0.046), (INNER_W - 0.26, 0.010, 0.040), materials["mat_corner_shadow"], root)
