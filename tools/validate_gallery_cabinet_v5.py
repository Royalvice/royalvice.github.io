...
GLB = ROOT / "public/assets/gallery/models/wooden-gallery-cabinet-v5.glb"
REPORT = ROOT / "public/assets/gallery/models/wooden-gallery-cabinet-v5.validation.json"
SOURCE_REPORT = ROOT / "public/assets/gallery/models/wooden-gallery-cabinet-v5.report.json"
LIGHTMAP = ROOT / "public/assets/gallery/materials/cabinet_lightmap_v5.png"
...
if not Path(sys.argv[-5]).exists():
    issues.append("missing cabinet_lightmap_v5.png")
if "mat_right_wall_dark" in materials:
    issues.append("legacy mat_right_wall_dark present in v5 production asset")
...
report = {
    ...
    "lightmap": str(Path(sys.argv[-5])),
    "lightmapBytes": Path(sys.argv[-5]).stat().st_size if Path(sys.argv[-5]).exists() else 0,
