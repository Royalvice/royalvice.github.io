...
GLB = ROOT / "public/assets/gallery/models/wooden-gallery-cabinet-v6.glb"
REPORT = ROOT / "public/assets/gallery/models/wooden-gallery-cabinet-v6.validation.json"
SOURCE_REPORT = ROOT / "public/assets/gallery/models/wooden-gallery-cabinet-v6.report.json"
LIGHTMAP = ROOT / "public/assets/gallery/materials/cabinet_lightmap_v6.png"
...
if not Path(sys.argv[-5]).exists():
    issues.append("missing cabinet_lightmap_v6.png")
if "mat_right_wall_dark" in materials:
    issues.append("legacy mat_right_wall_dark present in v6 production asset")
